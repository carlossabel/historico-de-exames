...
Formato exato:
{"valid":true,"d":"YYYY-MM-DD","prov":"nome do prestador ou estabelecimento","doc":"CNPJ ou CPF do prestador, somente numeros, ou vazio","v":123.45,"desc":"descricao curta do servico ou produto","cat":"categoria"}

Regras:
- "valid": true somente se o documento enviado for de fato uma nota fiscal, NFS-e, recibo de profissional liberal ou fatura de plano de saude/despesa medica-odontologica. Use false se o arquivo for outro tipo de documento (laudo de exame, foto, documento pessoal, contrato, algo ilegivel ou nao relacionado) — nesse caso pode deixar os demais campos vazios ou null, pois eles nao serao usados.
